...
function prestashop_user_compat_page_callback() {
    ...
    echo '<p>Enter here the value of the COOKIE_KEY, found in config/settings.inc.php of your former Prestashop installation.</p><form method="post" action="options.php">';
